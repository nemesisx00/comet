...
|[Garou: Mark of the Wolves](https://www.gog.com/game/garou_mark_of_the_wolves)|Version CM-2020.02.13 (2/13/2020)|🔲 Not Available|[`v0.2.0`](https://github.com/imLinguin/comet/releases/tag/v0.2.0)|🔲 No|🟩 Achievements 🟩 Leaderboard|There can be a delay of up to 10 or 15 minutes before the game will attempt to upload achievements. This is a problem with the game itself, not comet. The DotEmu version needs testing. Multiplayer is untested for both versions but should work.|
